...
// ─── Chat (Justin's Bot) ─────────────────────────────────────────────────────
// Moved to js/chat-app.jsx, which registers window.ChatApp. landing.html mounts
// that same component in its floating panel, so the bot has one implementation.

Object.assign(window, { FinderAbout, FinderSidebar, ProjectsApp, ExpApp, SkillsApp, WritingApp, MailApp, NowApp, PreviewApp });
